...
from modules.algorithm import compute_mutual_info, fplll_reduction,compute_mutual_info_gaussian,compute_dpc_rate,nearest_plane_algorithm,compute_mutual_info_lll,compute_mutual_info_ordered,compute_mutual_info_lll_ordered,nearest_plane_algorithm_ordered
from modules.utils import generate_channel, real_value_transform, calculate_optimal_D, mse_based_user_ordering, apply_ordering_to_symbols, reverse_ordering_to_symbols
from scipy.special import gamma,loggamma

class SimulationService:
    def __init__(self, config):
        self.config = config
        self.algNames = ['RO', 'RO-LLL', 'RO-D', 'RO-D-LLL','NP','NP-LLL','NP-D','NP-D-LLL']
    ...
    def run_single_trial(self, Nt, Nr, lost, P_tx):
        ...
        # 应用MSE排序
        H_ordered, ordering, permutation_matrix = mse_based_user_ordering(H_real)
        H_ordered_pinv = pinv(H_ordered)
        s_ordered = apply_ordering_to_symbols(s, ordering)
        ...
        a_ro_d_lll = T_lll_opt_inv@a_ro_lll
        ...
        a_np_lll = nearest_plane_algorithm(H_pinv,D_opt_np, s)
        rates.append(compute_mutual_info(H_pinv, D_opt_np, a_np_lll, s, P_tx, Nr))
        ...
        a_np_d_lll = T_lll_np_inv @ a_np_lll
